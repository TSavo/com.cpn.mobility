...
checkServers = (request, response, parameters) ->
  serverList = [{name:"vcg.00000001.telekom.vsp", host:"10.30.0.20", status:{working:true, openvpn:"<font color='red'>DOWN</font>", ipsec:"<font color='red'>DOWN</font>"}}, {name:"vcg.00000002.telekom.vsp", host:"10.30.0.22", status:{working:true, openvpn:"<font color='red'>DOWN</font>", ipsec:"<font color='red'>DOWN</font>"}}, {name:"vcg.00000003.telekom.vsp", host:"10.30.0.30", status:{working:true, openvpn:"<font color='red'>DOWN</font>", ipsec:"<font color='red'>DOWN</font>"}}]
